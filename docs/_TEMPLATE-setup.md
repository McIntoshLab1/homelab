...
What this service is and the role it plays in the Tosh Systems
environment. 
...
How this is reached and what protects it (e.g. "private over
Tailscale only" or "behind Nginx reverse proxy + SSL").
...
Links to the matching case study 
Helpful docs
